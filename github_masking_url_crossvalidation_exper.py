# -*- coding: utf-8 -*-
"""Github_Masking_URL_Crossvalidation_Exper.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1MIuhkgYbtOgEVt-76OVxWclxZFngTWh0
"""
...
results_file = "url_evaluation_results.txt"
...
np.savetxt("X_adv_pgd_url_norm.txt", X_adv_pgd, delimiter=",")
print("Saved PGD adversarial examples to 'X_adv_pgd_url_norm.txt'.")

# Generate FGSM adversarial examples
print("Generating FGSM adversarial examples...")
X_adv_fgsm = fgsm.generate(X_test_np)
np.savetxt("X_adv_fgsm_url_norm.txt", X_adv_fgsm, delimiter=",")
print("Saved FGSM adversarial examples to 'X_adv_fgsm_url_norm.txt'.")

# Generate DeepFool adversarial examples
print("Generating DeepFool adversarial examples...")
X_adv_df = deepfool.generate(X_test_np)
np.savetxt("X_adv_df_url.txt", X_adv_df, delimiter=",")
print("Saved DeepFool adversarial examples to 'X_adv_df_url.txt'.")
...
np.savetxt("X_adv_jsma_url.txt", X_adv_jsma, delimiter=",")
print("Saved JSMA adversarial examples to 'X_adv_jsma_url.txt'.")

# Generate HSJ adversarial examples
print("Generating HSJ adversarial examples...")
X_adv_hsj = hsj.generate(X_test_np)
np.savetxt("X_adv_hsj_url.txt", X_adv_hsj, delimiter=",")
print("Saved HSJ adversarial examples to 'X_adv_hsj_url.txt'.")

# Generate CW adversarial examples
print("Generating CW adversarial examples...")
X_adv_cw = cw_attack.generate(X_test_np)
#np.savetxt("X_adv_cw_agg_url2.txt", X_adv_cw, delimiter=",")
np.savetxt("X_adv_cw_agg_url_lessaggr_cic.txt", X_adv_cw, delimiter=",")

print("Saved CW adversarial examples to 'X_adv_cw_url2.txt'.")

# Generate ZOO adversarial examples
print("Generating ZOO adversarial examples...")
X_adv_zoo = zoo_attack.generate(X_test_np)
np.savetxt("X_adv_zoo_agg_url3.txt", X_adv_zoo, delimiter=",")
print("Saved ZOO adversarial examples to 'X_adv_zoo_url.txt'.")
...
#np.savetxt("X_adv_lowprofool.csv", adversarial_examples, delimiter=",")
np.savetxt("X_adv_lowprofool_lessaggr_cic.csv", adversarial_examples, delimiter=",")
